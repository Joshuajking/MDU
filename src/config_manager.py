...
class ConfigManager:
	...
	def load_config(self):
		try:
			...
			logger.error(f"Invalid JSON format in config file at {self.json_config_path}")
			raise ValueError(f"Invalid JSON format in config file at {self.json_config_path}")
