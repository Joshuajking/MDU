        ...
        while self._running.is_set():
            ...
            try:
                ...
                pilot = CharacterQuerySet.read_character_by_username(
                    config_manager.get_value("config.pilot")
                )
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.username_lable.setGeometry(
            QtCore.QRect(400, 20, 101, 21)
        )  # Adjusted height to match text edit
        ...
        self.email_lable.setGeometry(
            QtCore.QRect(400, 60, 101, 21)
        )  # Adjusted height to match text edit
        ...
        self.password_lable.setGeometry(
            QtCore.QRect(400, 110, 101, 21)
        )  # Adjusted height to match text edit
    ...
    def refresh_display(self):
        ...
        for character in characters_from_db:
            ...
            active = (
                character.active
            )  # Assuming you have an 'active' attribute in your Character model
            character_info = {
                "email": email,
                "password": password,
    ...
    def add_character(self):
        ...
        try:
            with Session(engine) as session:
                ...
                character = (
                    session.query(Character).filter_by(username=username).first()
                )
                if character:
