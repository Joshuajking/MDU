...
class DUFlight:
    ...
    def __init__(self):
        ...
        self.flight_images = ImageQuerySet.get_all_image_by_location(
    ...
    def flight_locations(self, retrieve_mode):
        ...
        image_to_compare = (
            self.config_manager.get_value("config.mission_retrieve_loc")
            if retrieve_mode
            else self.config_manager.get_value("config.mission_delivery_loc")
        )
